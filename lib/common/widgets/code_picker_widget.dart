...
class _CodePickerWidgetState extends State<CodePickerWidget> {
  ...
  void showCountryCodePickerDialog() {
    if (!GetPlatform.isAndroid && !GetPlatform.isIOS) {
      showDialog(
        barrierColor: widget.barrierColor ?? Colors.grey.withAlpha((0.5 * 255).toInt()),
          ...
          child: Container(
            ...
            child: Dialog(
              child: SelectionDialog(
                ...
                flagDecoration: widget.flagDecoration, headerTextStyle: TextStyle(),
                headerAlignment: MainAxisAlignment.center,
                hideHeaderText: true, topBarPadding: EdgeInsets.zero,
              ),
            ),
          ),
        ),
