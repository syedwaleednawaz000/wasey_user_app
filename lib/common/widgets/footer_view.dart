              ...
              child: Center(
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: Theme.of(context).cardColor.withAlpha((0.85 * 255).toInt()),
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Column(children: [
                                    ...
                                    const SizedBox(
                                        height: Dimensions.paddingSizeSmall),
                                    Text('send_us_mail'.tr, style: STCBold),
                                    const SizedBox(
                                        height: Dimensions.paddingSizeSmall),
                                    InkWell(
                                      onTap: () async {
                                  ...
                                  Column(children: [
                                    ...
                                    const SizedBox(
                                        height: Dimensions.paddingSizeSmall),
                                    Text('contact_us'.tr, style: STCBold),
                                    const SizedBox(
                                        height: Dimensions.paddingSizeSmall),
                                    Text(_config.phone ?? '',
                                        style: STCRegular.copyWith(
                                  ...
                                  Column(children: [
                                    ...
                                    const SizedBox(
                                        height: Dimensions.paddingSizeSmall),
                                    Text('find_us_here'.tr, style: STCBold),
                                    const SizedBox(
                                        height: Dimensions.paddingSizeSmall),
                                    SizedBox(
                                      width: 200,
      ...
      return InkWell(
        ...
        child: Text(title,
            style: hovered
                ...
                : STCRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall)),
      );
    });
  }
}
