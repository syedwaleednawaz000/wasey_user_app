...
class ItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      // height: 120,
      margin: EdgeInsets.only(top: 12, left: length! >= 3 ? 12 : 22),
      width: 150,
      child: Stack(
        children: [
          Container(
              ...
              child: TextHover(builder: (hovered) {
                return Padding(
                  padding: EdgeInsets.only(
                    bottom: desktop ? 0 : Dimensions.paddingSizeExtraSmall,
                    // top: desktop ? 0 : Dimensions.paddingSizeExtraSmall,
                  ),
                  child: length! >= 1
                      ? Column(
                                    ...
                                    height: imageHeight ??
                                        (desktop
                                            ...
                                            : length == null
                                                ? 120
                                                : 90),
                                    width: imageWidth ?? (desktop ? 120 : 150),
                                    fit: BoxFit.cover,
                                  ),
                                ),
                                (isStore || isCornerTag!)
