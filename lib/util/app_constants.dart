...
class AppConstants {
  ...
  static const String webHostedUrl = 'http://waseyapp.com';
  // static const String webHostedUrl = 'https://panel.jouanapp.com';
  static const String variationsBaseUrl = 'http://waseyapp.com/storage/app/public/product/variation/';
  static const bool useReactWebsite = false;

  static const String baseUrl = 'http://waseyapp.com';
  // static const String baseUrl = 'https://panel.jouanapp.com';
  static const String categoryUri = '/api/v1/categories';
  static const String bannerUri = '/api/v1/banners';
  static const String storeItemUri = '/api/v1/items/latest';
  static const String storeItemUriNewApi =
      '/api/v1/categories/sub-category-item';
  ...
  static final List<String> pizzaList = ['بيتزا', 'لبيستا', 'بيستا', 'pizza'];
}

bool isPizzaItem(Item item) {
  final pizzaKeywords = ['بيتزا', 'لبيستا', 'بيتسا', 'بيستا', 'pizza'];
  final itemName = item.name?.toLowerCase() ?? '';
  // final storeName = item.storeName?.toLowerCase() ?? '';

  return pizzaKeywords.any((p) => itemName.contains(p.toLowerCase()));
  // return pizzaKeywords.any((p) =>
  // itemName.contains(p.toLowerCase()) ||
  //     storeName.contains(p.toLowerCase()));
}
