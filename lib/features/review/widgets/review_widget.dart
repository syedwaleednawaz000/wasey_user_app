    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          children: [
            Expanded(
              child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(review.customerName ?? '', style: STCMedium),
                    ...
                    isDesktop
                        ? ReadMoreText(
                            ...
                            lessStyle: STCBold.copyWith(
                                color: Theme.of(context).primaryColor),
                            trimCollapsedText: 'show_more'.tr,
                            trimExpandedText: ' ${'show_less'.tr}',
                            moreStyle: STCBold.copyWith(
                                color: Theme.of(context).primaryColor),
                          )
                        : Text(
                            DateConverter.stringToLocalDateOnly(
      ...
      isDesktop
          ...
          : ReadMoreText(
              ...
              colorClickableText: Theme.of(context).primaryColor,
              lessStyle:
                  STCBold.copyWith(color: Theme.of(context).primaryColor),
              trimCollapsedText: 'show_more'.tr,
              trimExpandedText: ' ${'show_less'.tr}',
              moreStyle:
                  STCBold.copyWith(color: Theme.of(context).primaryColor),
      ...
      review.reply != null
          ? Container(
              ...
              decoration: BoxDecoration(
                color: Theme.of(context).hintColor.withAlpha((0.1 * 255).toInt()),
              ...
              child: Column(
                  ...
                  children: [
                    Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text(storeName ?? '', style: STCMedium),
                          Text(
                              DateConverter.stringToLocalDateOnly(
                                  review.updatedAt!),
                              style: STCRegular.copyWith(
