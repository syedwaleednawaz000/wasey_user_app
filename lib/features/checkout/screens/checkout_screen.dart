  ...
  void _setSinglePaymentActive() {
    if (!_firstTimeCheckPayment &&
      ...
      if (_isCashOnDeliveryActive!) {
        Get.find<CheckoutController>().setPaymentMethod(0, isUpdate: true);
      } else if (_isDigitalPaymentActive! &&
          Get.find<SplashController>()
                  .configModel!
                  .activePaymentMethodList!
                  .length ==
              1) {
        Get.find<CheckoutController>().setPaymentMethod(2, isUpdate: true);
          ...
          ? GetBuilder<CheckoutController>(builder: (checkoutController) {
              ...
              return GetBuilder<CouponController>(builder: (couponController) {
                ...
                double total = _calculateTotal(
                  subTotal: subTotal,
                  deliveryCharge: _deliveryCharge ?? 0.0,
                  discount: discount,
                  couponDiscount: couponDiscount,
                  taxIncluded: taxIncluded,
                  tax: tax,
                ...
                Future.delayed(Duration.zero, () {
                  _setSinglePaymentActive(); // ✅ هذا آمن
                });
                              ...
                              child: ResponsiveHelper.isDesktop(context)
                                  ...
                                  : Column(
                                      ...
                                      children: [
                                          ...
                                          //         isAvailable = false;
                                          //       } else {
                                          //         DateTime date = checkoutController
                                          //                     .selectedDateSlot ==
                                          //                 0
                                          //             ? DateTime.now()
                                          //             : DateTime.now().add(
                                          ...
                                          //               .text.isEmpty) {
                                          //         showCustomSnackBar(
                                          //             'please_enter_contact_person_name'
                                          //                 .tr);
                                          //       } else if (isGuestLogIn &&
                                          //           checkoutController
                                          //                   .orderType ==
                                          ...
                                          //               .text.isEmpty) {
                                          //         showCustomSnackBar(
                                          //             'please_enter_contact_person_number'
                                          //                 .tr);
                                          //       } else if (isGuestLogIn &&
                                          //           checkoutController
                                          //                   .orderType ==
                                          ...
                                          //               .text.isEmpty) {
                                          //         showCustomSnackBar(
                                          //             'please_enter_contact_person_email'
                                          //                 .tr);
                                          //       } else if (isGuestLogIn &&
                                          //           checkoutController
                                          //               .isCreateAccount &&
                                          ...
                                          //               .isEmpty) {
                                          //         showCustomSnackBar(
                                          //             'you_must_upload_prescription_for_this_order'
                                          //                 .tr);
                                          //       }
                                          ...
                                          //               .isEmpty) {
                                          //         showCustomSnackBar(
                                          //             'please_upload_your_prescription_images'
                                          //                 .tr);
                                          ...
                                          //                     .orderType ==
                                          //                 'take_away') {
                                          //           String number = checkoutController
                                          //                   .countryDialCode! +
                                          //               guestContactPersonNumberController
                                          //                   .text;
                                          ...
                                          //                 .address!,
                                          //             latitude: AddressHelper
                                          //                     .getUserAddressFromSharedPref()!
                                          //                 .latitude,
                                          //             longitude: AddressHelper
                                          //                     .getUserAddressFromSharedPref()!
                                          //                 .longitude,
                                          //             zoneId: AddressHelper
                                          //                     .getUserAddressFromSharedPref()!
                                          //                 .zoneId,
                                          //             email:
                                          //                 guestEmailController
                                          ...
                                          //                                 .fVariation!
                                          //                                 .isNotEmpty &&
                                          //                             cart.fVariation![i].values!.toppingOptions !=
                                          //                                 null &&
                                          //                             cart.fVariation!
                                          //                                 .isNotEmpty &&
                                          //                             cart
                                          ...
                                          //                               .label!
                                          //                               .add(j ==
                                          //                                       (cart.fVariation![i].values!.toppingOptions!.length - 1)
                                          //                                   ? "{'labelName':'${cart.fVariation![i].values!.label![j]}', 'info':'(${cart.fVariation![i].values!.toppingOptions![j]})'}"
                                          //                                   : "{'labelName':'${cart.fVariation![i].values!.label![j]}', 'info':'(${cart.fVariation![i].values!.toppingOptions![j]})'}");
                                          //
                                          //                           toppingOptions.add(ToppingOption(
                                          //                               labelName:
                                          //                                   cart.fVariation![i].values!.label![
                                          //                                       j],
                                          //                               info: cart
                                          //                                   .fVariation![i]
                                          //                                   .values!
                                          ...
                                          //                           print(ToppingOption(
                                          //                                   labelName:
                                          //                                       cart.fVariation![i].values!.label![j],
                                          //                                   info: cart.fVariation![i].values!.toppingOptions![j])
                                          //                               .toJson()
                                          //                               .toString());
                                          //                           if (kDebugMode) {
                                          //                             print(
                                          //                                 "fVariationLabelsWithTTopping");
                                          //                             print(
                                          //                                 "${cart.fVariation![i].values!.label![j]} (${cart.fVariation![i].values!.toppingOptions![j]})");
                                          //                             print(
                                          //                                 "{'labelName':'${cart.fVariation![i].values!.label![j]}', 'info':'(${cart.fVariation![i].values!.toppingOptions![j]})}'");
                                          //                           }
                                          //                         } else {
                                          ...
                                          //                     .notAvailableIndex]
                                          //                 : '',
                                          //             deliveryInstruction: checkoutController
                                          //                         .selectedInstruction !=
                                          //                     -1
                                          //                 ? AppConstants
                                          ...
                                          //                 ? int.parse(AuthHelper
                                          //                     .getGuestId())
                                          //                 : 0,
                                          //             isBuyNow: widget.fromCart
                                          //                 ? 0
                                          //                 : 1,
