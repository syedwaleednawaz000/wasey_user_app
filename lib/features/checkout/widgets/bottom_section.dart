          ...
          ? Align(
              ...
              child: Padding(
                ...
                child: Text('order_summary'.tr,
                    style:
                        STCBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
              ),
            )
          : const SizedBox(),
      Padding(
          ...
          children: [
                ...
                ? Row(
                    ...
                    children: [
                        ...
                        Text(PriceConverter.convertPrice(subTotal),
                            style: STCMedium, textDirection: TextDirection.ltr),
                      ])
                : const SizedBox(),
            ...
            (couponController.discount! > 0 || couponController.freeDelivery)
                ? Column(children: [
                    Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text('coupon_discount'.tr, style: STCRegular),
            ...
            referralDiscount > 0
                ? Column(children: [
                    Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text('referral_discount'.tr, style: STCRegular),
                          Text(
            ...
            (!takeAway &&
                ...
                ? Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('delivery_man_tips'.tr, style: STCRegular),
                      Text(
            ...
            (checkoutController.store!.extraPackagingStatus! &&
                ...
                ? Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('extra_packaging'.tr, style: STCRegular),
                      Text(
            ...
            (AuthHelper.isGuestLoggedIn() &&
                ...
                : Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                        Text('delivery_fee'.tr, style: STCRegular),
                        checkoutController.distance == -1
                            ? Text(
                                'calculating'.tr,
                                style: STCRegular.copyWith(color: Colors.red),
                              )
                            : (deliveryCharge == 0 ||
                                    (couponController.coupon != null &&
                                        couponController.coupon!.couponType ==
            ...
            checkoutController.isPartialPay
                ? Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                        Text('paid_by_wallet'.tr, style: STCRegular),
                        Text(
            ...
            Padding(
              ...
              child: Divider(
                  thickness: 1,
                  color: Theme.of(context).hintColor.withAlpha((0.5 * 255).toInt())),
            ),
          ],
        ),
      ),
