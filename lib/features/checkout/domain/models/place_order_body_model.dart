...
class PlaceOrderBodyModel {
  ...
  double? _orderAmount;
  double? _minimum_shipping_charge;
  String? _orderType;
  ...
  int? _createNewUser;
  String? _password;
  List<ToppingOption>? _selectedToppings; // <<< NEW FIELD ADDED HERE
  ...
  PlaceOrderBodyModel({
    ...
    double minimum_shipping_charge = 0.00,
    ...
    List<ToppingOption>? selectedToppings, // <<< NEW PARAMETER
  }) {
    _cart = cart;
    _couponDiscountAmount = couponDiscountAmount;
    _orderAmount = orderAmount;
    _minimum_shipping_charge = minimum_shipping_charge;
    ...
    _password = password;
    _selectedToppings = selectedToppings; // <<< ASSIGN NEW PARAMETER
  }
  ...
  PlaceOrderBodyModel.fromJson(Map<String, dynamic> json) {
    if (json['cart'] != null) {
      _cart = [];
      // Assuming OnlineCart.fromJson exists and is correct
    ...
    // Should it be _minimum_shipping_charge?
    _minimum_shipping_charge = json['minimum_shipping_charge'] != null
        ? double.parse(json['minimum_shipping_charge'].toString())
        : 0.0; // Corrected this line
    ...
    if (json['viration_new'] != null && json['viration_new'] is String) {
      _selectedToppings = [];
...
//     _couponDiscountAmount = double.parse(json['coupon_discount_amount'] ?? 0.toString());
//     _orderAmount = double.parse(json['order_amount'].toString());
//     _orderAmount = double.parse(json['minimum_shipping_charge'].toString());
//     _orderType = json['order_type'];
//     _paymentMethod = json['payment_method'];
//     _orderNote = json['order_note'];
//     _couponCode = json['coupon_code'];
...
class OrderVariationValue {
  ...
  OrderVariationValue({this.label, this.toppingOptions});
