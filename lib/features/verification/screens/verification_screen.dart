              ...
              Padding(
                ...
                child: PinCodeTextField(
                  ...
                  pinTheme: PinTheme(
                    ...
                    inactiveColor:
                        Theme.of(context).disabledColor.withAlpha((0.6 * 255).toInt()),
                    ...
                    onPressed: verificationController.verificationCode.length <
                        ...
                        : () {
                            if (widget.firebaseSession != null &&
                              ...
                              debugPrint('InsideIfCondition => Firebase Session: ${widget.firebaseSession}');
                              verificationController
                                ...
                                isSignUpPage: widget.loginType ==
                                  ...
                                  .then((value) {
                                if (value.isSuccess) {
                                  debugPrint('InsideIfSuccess => Firebase Session:  ${value.isSuccess}');
                                  _handleVerifyResponse(value, _number, _email);
                                } else {
                                  debugPrint('InsideElseCondition => Firebase Session:  ${value.isSuccess}');
                                  showCustomSnackBar(value.message);
                                  _handleVerifyResponse(value, _number, _email);
                                }
                              });
                            } else if (widget.userModel != null) {
                              debugPrint("InsideElseIfUserModel => ${widget.userModel!.toJson().toString()}");
                              ...
                              debugPrint("InsideElseIfFromSignUp => ${widget.fromSignUp}");
                              print("Phone: $_number");
                              print("Email: $_email");
                              print("Verification Type: ${_number != null ? VerificationTypeEnum.phone.name : VerificationTypeEnum.email.name}");
                              print("OTP: ${verificationController.verificationCode}");
                              ...
                              verificationController
                                ...
                                guestId: AuthHelper.getGuestId(),
                                  ...
                                  .then((value) {
                                if (value.isSuccess) {
                                  debugPrint("InsideIfSuccessFromSignUp => ${value.isSuccess}");
                                  _handleVerifyResponse(value, _number, _email);
                                } else {
                                  debugPrint("InsideElseFromSignUp => ${value.message}");
                                  showCustomSnackBar(value.message);
                                }
                              });
                            } else {
                              debugPrint("InsideElseIfFromForgetPassword => ${widget.fromForgetPassword}");
                              verificationController
                                  .verifyToken(_number)
                                  .then((value) {
                                if (value.isSuccess) {
  ...
  void _handleVerifyResponse(
    ...
    if (response.authResponseModel != null &&
      ...
      if (ResponsiveHelper.isDesktop(context)) {
        ...
        debugPrint("InsideIfResponse => ${response.authResponseModel!.isExistUser!.toJson().toString()}");
      ...
      if (ResponsiveHelper.isDesktop(context)) {
        ...
        debugPrint("InsideElseIfResponse => NewUserDialog");
