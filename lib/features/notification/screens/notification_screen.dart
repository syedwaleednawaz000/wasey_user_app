                                                                        ...
                                                                        children: [
                                                                          Expanded(
                                                                            child:
                                                                              ...
                                                                              style: STCBold.copyWith(
                                                                                color: isSeen ? Theme.of(context).textTheme.bodyLarge?.color?.withAlpha((0.5 * 255).toInt()) : Theme.of(context).textTheme.bodyLarge?.color,
                                                                          ...
                                                                          Padding(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              style: STCRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color, fontSize: Dimensions.fontSizeSmall),
                                                                            ),
                                                                          ),
                                                                        ]),
                                                                    const SizedBox(
                                                                        ...
                                                                        children: [
                                                                          Expanded(
                                                                            child:
                                                                              ...
                                                                              maxLines: 2,
                                                                              overflow: TextOverflow.ellipsis,
                                                                              style: STCRegular.copyWith(color: isSeen ? Theme.of(context).disabledColor : Theme.of(context).textTheme.bodyLarge?.color?.withAlpha((0.7 * 255).toInt())),
                                                                            ),
                                                                          ),
                                                                          const SizedBox(
