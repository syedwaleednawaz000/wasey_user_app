    ...
    return Container(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Text(userModel.name ?? 'Jhon Doe',
            style: STCMedium, textAlign: TextAlign.center),
        const SizedBox(height: Dimensions.paddingSizeLarge),
        Text('is_it_you'.tr, style: STCBold, textAlign: TextAlign.center),
            ...
            TextSpan(
              text:
                  'you_entered_has_already_been_used_and_has_an_existing_account'
                      .tr,
              style:
                  STCRegular.copyWith(color: Theme.of(context).disabledColor),
            ),
          ]),
        ),
