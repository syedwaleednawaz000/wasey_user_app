    ...
    return GetBuilder<AuthController>(builder: (authController) {
      ...
      return Column(mainAxisSize: MainAxisSize.min, children: [
        Align(
          ...
          child: Text('login'.tr,
              style: STCBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge)),
        ),
          ...
          InkWell(
            ...
            child: Row(
              ...
              children: [
                ...
                Text('remember_me'.tr, style: STCRegular),
              ],
            ),
          ),
          TextButton(
            ...
            child: Text('${'forgot_password'.tr}?',
                style:
                    STCRegular.copyWith(color: Theme.of(context).primaryColor)),
          ),
        ]),
