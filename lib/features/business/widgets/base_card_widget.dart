...
//               child: Text(title, style: STCMedium.copyWith(color: businessController.businessIndex == index ? Theme.of(context).primaryColor : Theme.of(context).textTheme.bodyLarge?.color?.withAlpha((0.7 * 255).toInt()), fontSize: Dimensions.fontSizeDefault,
...
//
//             isDesktop ? Text(
//               description ?? '', style: STCRegular.copyWith(fontSize: Dimensions.fontSizeSmall,
