...
class CartService implements CartServiceInterface {
  ...
  List<CartModel> formatOnlineCartToLocalCart(
    ...
    for (OnlineCartModel cart in onlineCartModel) {
      debugPrint('formatOnlineCartToLocalCart ===> onlineCart: ${cart.toJson()}');
      ...
      List<online_cart.Variation> fVariation = [];
      ...
      debugPrint('formatOnlineCartToLocalCart ===> cartModel: ${cartModel.toJson()}');
