              ...
              ? Padding(
                  ...
                  child: Column(children: [
                    Row(
                        ...
                        children: [
                          Text('item_price'.tr, style: STCRegular),
                          PriceConverter.convertAnimationPrice(
                              cartController.itemPrice,
                              textStyle: STCRegular),
                        ]),
                    ...
                    Get.find<SplashController>()
                        ...
                        ? Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text('variations'.tr, style: STCRegular),
                              Text(
                                  '(+) ${PriceConverter.convertPrice(cartController.variationPrice)}',
                                  style: STCRegular,
                    ...
                    Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text('discount'.tr, style: STCRegular),
                          storeController.store != null
                              ? Row(children: [
                                  Text('(-)', style: STCRegular),
                                  PriceConverter.convertAnimationPrice(
                              ...
                              : Text('calculating'.tr, style: STCRegular),
                          // Text('(-) ${PriceConverter.convertPrice(cartController.itemDiscountPrice)}', style: STCRegular, textDirection: TextDirection.ltr),
                        ]),
                    SizedBox(
                        height: Get.find<SplashController>()
                                .configModel!
                    ...
                    Get.find<SplashController>()
                        ...
                        ? Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text('addons'.tr, style: STCRegular),
                              Text(
              ...
              child: Row(
                ...
                children: [
                  ...
                  PriceConverter.convertAnimationPrice(cartController.subTotal,
                      textStyle: STCRegular.copyWith(
                          color: Theme.of(context).primaryColor)),
                  // Text(
                  //   PriceConverter.convertPrice(cartController.subTotal),
                  //   style: STCMedium.copyWith(color: ResponsiveHelper.isDesktop(context) ? Theme.of(context).textTheme.bodyLarge!.color : Theme.of(context).primaryColor), textDirection: TextDirection.ltr,
                  // ),
                ],
              ),
            ),
