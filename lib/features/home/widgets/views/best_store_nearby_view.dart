                                                                              ...
                                                                              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                                                ...
                                                                                storeList[index].ratingCount! > 0
                                                                                    ? Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                                                                                        ...
                                                                                        const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                                                                        Text(storeList[index].avgRating!.toStringAsFixed(1), style: STCRegular),
                                                                                        const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                                                      ...
                                                                      child: Row(
                                                                          ...
                                                                          children: [
                                                                            Text('${distance > 10 ? '10+' : distance.toStringAsFixed(1)} ${'km'.tr}',
                                                                                style: STCBold.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeOverSmall)),
                                                                            const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                                                            Text('from_you'.tr,
                                                                                style: STCRegular.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeOverSmall)),
                                                                          ]),
                                                                    ),
                                                                  ),
                                                                ]),
