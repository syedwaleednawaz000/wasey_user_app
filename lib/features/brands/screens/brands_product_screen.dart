        ...
        return Shimmer(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: Get.isDarkMode ? Colors.white.withAlpha((0.05 * 255).toInt()) : Colors.grey[300],
              borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
              boxShadow: [BoxShadow(color: Get.isDarkMode ? Colors.black12 : Colors.grey.withAlpha((0.1 * 255).toInt()), spreadRadius: 1, blurRadius: 5, offset: const Offset(0, 1))],
            ),
            child: Row(children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                  color: Get.isDarkMode ? Theme.of(context).disabledColor.withAlpha((0.2 * 255).toInt()) : Theme.of(context).cardColor,
                ),
              ),
              ...
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                  Container(height: 20, width: double.maxFinite, color: Get.isDarkMode ? Theme.of(context).disabledColor.withAlpha((0.2 * 255).toInt()) : Theme.of(context).cardColor),
                  const SizedBox(height: Dimensions.paddingSizeSmall),
                  Container(height: 15, width: double.maxFinite, color: Get.isDarkMode ? Theme.of(context).disabledColor.withAlpha((0.2 * 255).toInt()) : Theme.of(context).cardColor),
                  const SizedBox(height: Dimensions.paddingSizeSmall),
                  Container(height: 15, width: double.maxFinite, color: Get.isDarkMode ? Theme.of(context).disabledColor.withAlpha((0.2 * 255).toInt()) : Theme.of(context).cardColor),
                ]),
              ),
