...
class _MarketScreenState extends State<MarketScreen> {
  ...
  void initState() {
    ...
    // The initState is now clean and simple.
    // It calls the loadMarketData method from our new MarketController.
    Get.find<MarketController>().loadMarketData(false);
    // Get.find<HomeController>().setModuleSuperMarket();
    // // Get.find<MarketController>().setModuleSuperMarket();
    // MarketScreen.loadData(false).then((value) {
        ...
        return Scaffold(
          ...
          body: isParcel
            ...
            child: RefreshIndicator(
              onRefresh: ()async{
                await marketController.loadMarketData(true);
              },
              // onRefresh: () async {
              ...
              child: ResponsiveHelper.isDesktop(context)
                ...
                scrollController: _scrollController,
                  ...
                  : marketController.isLoading
              // ModuleShimmer(isEnabled: isEnabled)
          ...
          //     marketController.cashBackOfferList != null &&
