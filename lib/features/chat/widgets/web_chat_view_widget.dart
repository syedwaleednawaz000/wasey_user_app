    ...
    return Column(
      children: [
        Container(
          ...
          child: Center(child: Text('live_chat'.tr, style: STCMedium)),
        ),
                                          ...
                                          child: Column(
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                // Text('(${widget.chatController.notificationBody!.receiverType!.tr})', style: STCRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor)),
                                              ],
                                            ),
                                            const SizedBox(
                                                height: Dimensions
